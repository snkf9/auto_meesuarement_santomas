...
export declare type SocketEvents = uWaveSocket.AclAllow | uWaveSocket.AclDisallow | uWaveSocket.Advance | uWaveSocket.Authenticated | uWaveSocket.Ban | uWaveSocket.ChatDelete | uWaveSocket.ChatDeleteID | uWaveSocket.ChatDeleteUser | uWaveSocket.ChatMessage | uWaveSocket.ChatMute | uWaveSocket.ChatUnmute | uWaveSocket.Favorite | uWaveSocket.Join | uWaveSocket.Leave | uWaveSocket.NameChange | uWaveSocket.PlaylistCycle | uWaveSocket.RoleChange | uWaveSocket.Skip | uWaveSocket.Unban | uWaveSocket.Vote | uWaveSocket.WaitlistAdd | uWaveSocket.WaitlistClear | uWaveSocket.WaitlistJoin | uWaveSocket.WaitlistLeave | uWaveSocket.WaitlistLock | uWaveSocket.WaitlistMove | uWaveSocket.WaitlistRemove | uWaveSocket.WaitlistUpdate;
declare type SocketCommands = SocketEvents['command'];
declare type LibCommands = 'login' | 'connected' | 'disconnected' | 'error';
export declare type Commands = SocketCommands | LibCommands;
export interface SocketPayloadsMap extends Record<Commands, SocketEvents['data']> {
